      ...
      {open && (
        <>
          <motion.div
            ...
            onClick={onClose}
            className="fixed inset-0 z-[230] bg-black/60 xl:hidden"
          />
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[240] flex h-[min(82dvh,720px)] max-h-[calc(100dvh-env(safe-area-inset-top)-1rem)] flex-col overflow-hidden rounded-t-[32px] border-t border-[var(--fc-app-border)] bg-[var(--fc-app-surface)] shadow-2xl shadow-black/50 xl:hidden"
          >

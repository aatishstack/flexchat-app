export default function AuthBackground() {
  return (
    <>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_8%,rgba(36,129,204,0.22),transparent_30%),radial-gradient(circle_at_80%_22%,rgba(6,182,212,0.10),transparent_26%),linear-gradient(135deg,#050811_0%,#090d19_52%,#081625_100%)]" />

...
export const CHAT_THEMES: ChatTheme[] = [
  createTheme({
    ...
    accent: "#fff2bd",
    warm: "#fff2bd",
    ownBubble: "linear-gradient(135deg, #285ccc 0%, #3f78e9 58%, #fff2bd 160%)",
    theirBubble: "linear-gradient(145deg, rgba(255,242,189,0.11), rgba(255,255,255,0.055))",
  }),
  createTheme({
    id: "buttermilk-day",
    name: "Buttermilk Day",
  ...
  createTheme({
    ...
    accent: "#d946ef",
    warm: "#f0abfc",
    ownBubble: "linear-gradient(135deg,#7c3aed,#9333ea,#d946ef)",
  }),
  createTheme({
    id: "aurora",
    name: "Aurora",
    ...
    accent: "#14b8a6",
    warm: "#a7f3d0",
    ownBubble: "linear-gradient(135deg,#14b8a6,#06b6d4,#8b5cf6)",
  }),
  createTheme({
    id: "velvet",
    name: "Velvet",
    ...
    accent: "#be185d",
    warm: "#f9a8d4",
    ownBubble: "linear-gradient(135deg,#be185d,#db2777,#7c3aed)",
  }),
  createTheme({
    id: "midnight",
    name: "Midnight",
    ...
    accent: "#64748b",
    warm: "#93c5fd",
    ownBubble: "linear-gradient(135deg,#334155,#2563eb,#7c3aed)",
  }),
  createTheme({
    id: "emerald",
    name: "Emerald",
  ...
  createTheme({
    ...
    accent: "#06b6d4",
    warm: "#14b8a6",
    ownBubble: "linear-gradient(135deg,#8b5cf6,#06b6d4,#14b8a6)",
  }),
  createTheme({
    id: "mono",
    name: "Mono",
  ...
  createTheme({
    ...
    accent: "#a855f7",
    warm: "#fda4af",
    ownBubble: "linear-gradient(135deg,#e11d48,#f43f5e,#a855f7)",
  }),
  createTheme({
    id: "ice",
    name: "Ice",
    ...
    accent: "#38bdf8",
    warm: "#818cf8",
    ownBubble: "linear-gradient(135deg,#2563eb,#38bdf8,#818cf8)",
  }),
  createTheme({
    id: "gold",
    name: "Gold",
  ...
  createTheme({
    ...
    accent: "#c084fc",
    warm: "#a7f3d0",
    ownBubble: "linear-gradient(135deg,#22d3ee,#a7f3d0,#c084fc)",
  }),
];
